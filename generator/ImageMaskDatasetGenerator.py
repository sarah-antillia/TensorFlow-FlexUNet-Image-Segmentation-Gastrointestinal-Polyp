...
#
# 2025/08/08 ImageMaskDatasetGenerator.py
...
class ImageMaskDatasetGenerator:
  ...
  def generate(self):
    masks_files = glob.glob(self.masks_dir + "/*.jpg")
...
if __name__ == "__main__":
  try:
    ...
    output_dir        = "./Kvasir-PNG-master/"
    output_images_dir = "./Kvasir-Polyp-PNG-master/images/"
    output_masks_dir  = "./Kvasir-Polyp-PNG-master/masks/"
